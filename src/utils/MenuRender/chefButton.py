...
def run_chef_button():
    ...
    order_texts = [["Orders:", "Table 1: Chicken"], ["Orders:", "Table 2: Fish"], ["Orders:", "Table 3: Steak"]]
        ...
        for event in pygame.event.get():
            if event.type == pygame.QUIT:
                ...
                if event.key == pygame.K_ESCAPE:  # If the escape key is pressed
                    ...
                    order_texts.append(["Orders:", "Table {}: New Order".format(len(order_texts) + 1)])  # Add a new order
